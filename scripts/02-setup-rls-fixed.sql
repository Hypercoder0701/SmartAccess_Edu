...
CREATE POLICY "Students can update their own test results" ON public.test_results
...
DO $$
BEGIN
    RAISE NOTICE '🔒 Row Level Security (RLS) muvaffaqiyatli sozlandi!';
    RAISE NOTICE '✅ Barcha jadvallar uchun xavfsizlik qoidalari yaratildi';
    RAISE NOTICE '';
    RAISE NOTICE '🔄 Keyingi qadam: Real-time funksiyalarni yoqish';
END $$;
